...
import { addAppointment } from "@/actions/appointment/add-appointment.action";
import { getAvailableTimes } from "@/actions/get-available-times.action";
  ...
  useEffect(() => {
    if (selectedDoctorId) {
      ...
      if (selectedDoctor) {
        form.setValue(
          "appointmentPrice",
          selectedDoctor.appontmentPriceInCents / 100,
        );
      }
    }
